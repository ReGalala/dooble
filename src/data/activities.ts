...
export const SEED_ACTIVITIES: Activity[] = [
  ...
  { id: 18, name: "Volvo Museum Experience", category: "Museum", rating: 4.8, time: "10:00–17:00", address: "Arendals Skans", lat: 57.6950, lng: 11.8200, description: "A journey through history and into the future. See everything from the first ÖV4 to the latest concept cars.", company: "World of Volvo", companyEmail: "info@worldofvolvo.com", price: 180, ticketsRemaining: 100, availableUntil: "2026-12-31", status: "active", image: "/images/volvo-museum.jpg" },

  // --- Slottsskogen (placeholder) ---
  { id: 19, name: "Slottsskogen Picnic & Zoo", category: "Outdoors", rating: 4.9, time: "00:00–23:59", address: "Slottsskogen", lat: 57.6850, lng: 11.9400, description: "Gothenburg's main park with a free zoo featuring elks, seals, and penguins. Perfect for picnics and walks.", company: "Gothenburg City", companyEmail: "kontakt@goteborg.se", price: 0, ticketsRemaining: 999, availableUntil: "2026-12-31", status: "active", image: "/images/slottsskogen.jpg" },

  // --- Botanical Garden (placeholder) ---
  { id: 20, name: "Botanical Garden Walk", category: "Outdoors", rating: 4.8, time: "09:00–21:00", address: "Carl Skottsbergs gata 22A", lat: 57.6830, lng: 11.9500, description: "One of the larger botanical gardens in Europe. Explore the rock garden, the rhododendron valley, and the Japanese glade.", company: "Botaniska", companyEmail: "info@botaniska.se", price: 30, ticketsRemaining: 500, availableUntil: "2026-12-31", status: "active", image: "/images/botanical-garden.jpg" },

  
  // --- Chalmers (Demo Provider) 14-day Last Minute Rolling Slots ---
  { id: 21, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-20T21:00:00", startsAt: "2026-03-20T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 22, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-21T21:00:00", startsAt: "2026-03-21T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 23, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-22T21:00:00", startsAt: "2026-03-22T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 24, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-23T21:00:00", startsAt: "2026-03-23T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 25, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-24T21:00:00", startsAt: "2026-03-24T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 26, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-25T21:00:00", startsAt: "2026-03-25T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 27, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-26T21:00:00", startsAt: "2026-03-26T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 28, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-27T21:00:00", startsAt: "2026-03-27T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 29, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-28T21:00:00", startsAt: "2026-03-28T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 30, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-29T21:00:00", startsAt: "2026-03-29T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 31, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-30T21:00:00", startsAt: "2026-03-30T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  { id: 32, name: "Dragons' Den Pitch Night", category: "Networking", rating: 4.9, time: "18:00–21:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "pitch your idea, get money!", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 0, ticketsRemaining: (Math.random() < 0.5 ? 2 : 5), availableUntil: "2026-03-31T21:00:00", startsAt: "2026-03-31T18:00:00", status: "active", image: "/images/dragons-den.jpg", lastMinute: true },
  ...
  // --- Archived past provider activities (mail@chalmers.com — back the Dashboard insights) ---
  { id: 910, name: "Startup Breakfast Meetup", category: "Networking", rating: 4.4, time: "08:00–10:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "An early-morning networking breakfast for founders, students, and investors. Pitch your idea over coffee.", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 90, ticketsRemaining: 0, availableUntil: "2025-10-15", status: "inactive", image: "/images/dragons-den.jpg", ratingCount: 38 },
  { id: 911, name: "Tech Networking Evening", category: "Networking", rating: 4.6, time: "17:30–20:30", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "Connect with tech professionals, researchers and startup founders over drinks and lightning talks.", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 120, ticketsRemaining: 0, availableUntil: "2025-11-20", status: "inactive", image: "/images/dragons-den.jpg", ratingCount: 61 },
  { id: 912, name: "AI for Students Workshop", category: "Workshop", rating: 4.7, time: "13:00–17:00", address: "Chalmers Lindholmen, Hörselgången 4, 417 56 Göteborg", lat: 57.7075, lng: 11.9380, description: "Hands-on introduction to machine learning and AI tools. No prior experience needed — bring your laptop.", company: "Demo Provider", companyEmail: "mail@chalmers.com", price: 100, ticketsRemaining: 0, availableUntil: "2026-01-10", status: "inactive", image: "/images/dragons-den.jpg", ratingCount: 49 },
